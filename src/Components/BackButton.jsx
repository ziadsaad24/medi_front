...
const BackButton = ({ path = '/' }) => {
  ...
  return (
    <div className="w-full flex justify-end mb-4 items-center gap-2">
      <button 
        onClick={() => navigate(path)} 
        className="custom-btn bg-[#00607A] text-white px-5 py-2 rounded-lg shadow-md hover:brightness-110 transition font-bold flex items-center gap-2 cursor-pointer"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M15.5386 4.5L20.7548 9.34362C21.5489 10.081 22.0001 11.1158 22.0001 12.1994C22.0001 13.3418 21.4989 14.4266 20.629 15.1671L15.5386 19.5" 

...
export default function ContactPage() {
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col min-h-screen bg-[#020617] text-white overflow-hidden" dir="rtl">
        
        <main className="flex-grow pt-32 pb-20 relative">
          
          {/* الخلفيات المضيئة - ممتدة لمالي الشاشة */}
          <div className="fixed top-[-10%] left-[-10%] w-[800px] h-[800px] bg-blue-600/10 blur-[150px] pointer-events-none" />
          <div className="fixed bottom-[-10%] right-[-10%] w-[700px] h-[700px] bg-indigo-600/10 blur-[130px] pointer-events-none" />
            ...
            <header className="mb-16">
              ...
              >
                <div className="flex items-center justify-center md:justify-start gap-4 mb-4">
                  ...
                  <h1 className="text-5xl md:text-7xl font-black tracking-tighter">تواصل <span className="text-blue-500">معنا</span></h1>
                </div>
                <p className="text-slate-400 text-xl font-medium max-w-2xl">نحن هنا لخدمتك، أرسل استفسارك وسيقوم فريقنا بالرد عليك في أسرع وقت.</p>
              </motion.div>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
              ...
              >
                {[
                  ...
                  <div key={idx} className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:border-blue-500/20 hover:bg-white/[0.04] transition-all group relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-5 relative z-10">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-black text-white mb-1 tracking-tight">{item.value}</p>
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, y: 0 }}
                className="lg:col-span-8 bg-[#0f172a]/40 border border-white/10 p-10 md:p-16 rounded-[4rem] shadow-2xl backdrop-blur-sm relative overflow-hidden"
              >
                <AnimatePresence mode="wait">
                  {!isSubmitted ? (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-3">
                          <label className="text-sm font-bold text-slate-400 mr-2">الأسم الكامل</label>
                          <input 
                            placeholder="أدخل اسمك.." required
                            className="w-full bg-white/[0.03] border border-white/10 p-6 rounded-[2rem] outline-none focus:border-blue-500 focus:bg-white/[0.07] transition-all text-white text-lg"
                            onChange={(e) => setFormData({...formData, name: e.target.value})}
                          />
                        </div>
                        <div className="space-y-3">
                          <label className="text-sm font-bold text-slate-400 mr-2">البريد الإلكتروني</label>
                          <input 
                      ...
                      <div className="space-y-3">
                        <label className="text-sm font-bold text-slate-400 mr-2">رسالتك التفصيلية</label>
                        <textarea 
                          rows="6" placeholder="اكتب استفسارك هنا بكل وضوح.." required
                          className="w-full bg-white/[0.03] border border-white/10 p-6 rounded-[2rem] outline-none focus:border-blue-500 focus:bg-white/[0.07] transition-all text-white text-lg resize-none"
                    ...
                    >
                      ...
                      <h3 className="text-4xl font-black text-white mb-4">تم استلام رسالتك!</h3>
                      <p className="text-slate-400 text-xl font-medium">فريق Medicare سيتواصل معك خلال الدقائق القادمة.</p>
                      <button 
                        onClick={() => setIsSubmitted(false)}
                        className="mt-10 bg-white/5 border border-white/10 px-8 py-3 rounded-full hover:bg-white/10 transition-all text-sm font-bold"
                      >
                        إرسال رسالة أخرى
                      </button>
                    </motion.div>
